package com.example.xiaojin20135.esptouch;

import android.content.Context;

import com.example.xiaojin20135.esptouch.task.EsptouchTaskParameter;
import com.example.xiaojin20135.esptouch.task.IEsptouchTaskParameter;
import com.example.xiaojin20135.esptouch.task.__EsptouchTask;
...
public class EsptouchTask implements IEsptouchTask {
	...
	public EsptouchTask(String apSsid, String apBssid, String apPassword, Context context) {
		...
		_mEsptouchTask = new __EsptouchTask(apSsid, apBssid, apPassword, context, _mParameter, true);
	}
